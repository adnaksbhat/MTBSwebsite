...
<body>
	...
	<form  class="form-container" method="post" action="/bookNow">
		...
		<input type="text" placeholder="Select Movie" name="mname" value="{{$item->mname}}">
		@endforeach
		<label>Theatres</label><br>
		<select name="tname">
			@foreach($res2 as $it)
			<option>{{$it->tname}}</option>
			@endforeach
		</select><br>
...
<!-- <div class="form-popup" id="myForm">
  <form action="/action_page.php" class="form-container">
    ...
    <input type="text" placeholder="Enter Movie Name" name="mname" value="{{$item->mname}}"> >
